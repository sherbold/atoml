...
import atoml.smoke.StarvedBinaryCategorical;
import atoml.smoke.StarvedManyCategories;
import atoml.smoke.TenCategorical;
...
public class Runner {
	...
	public static void main(String[] args) {
		...
		smokeTests.add(new BinaryCategorical());
		smokeTests.add(new TenCategorical());
		smokeTests.add(new StarvedBinaryCategorical());
		smokeTests.add(new StarvedManyCategories());
		smokeTests.add(new ManyCategories());
		smokeTests.add(new NonoverlappingTrainingAndTestDataCategorical());
