...
public class TensorFlowTemplate implements TemplateEngine {
     ...
     */
    public TensorFlowTemplate(Algorithm algorithmUnderTest) {
    ...
    private static boolean needsQuotes(String value) {
        ...
        boolean isParameterObject = value.contains("(");
        return  !(isNone || isBoolean || isNumber || isTuple || isList || isDict || isParameterObject);
    }
}
