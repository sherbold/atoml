...
/**
 * Features: uniformly distributed in [0,10^-6]
 * Class: rectangle of quantiles
 * 
 * @author sherbold
 */
public class MinFloat extends AbstractSmokeTest {
	...
	public void generateData(int numFeatures, int numInstances, long seed) {
		data = DataGenerator.generateData(numFeatures, numFeatures, numInstances, new UniformRealDistribution(0,1e-6), 0.1, seed);
		testdata = data;
	}
