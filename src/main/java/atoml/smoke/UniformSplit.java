 ...
 * @author sherbold
 */
public class UniformSplit extends AbstractSmokeTest {
	...
	public void generateData(int numFeatures, int numInstances, long seed) {
		...
		testdata = DataGenerator.generateData(numFeatures, numFeatures, numInstances, new UniformRealDistribution(0,1), 0.1, seed+1);
	}
